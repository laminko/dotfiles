...
export ZSH="/Users/lmk/.oh-my-zsh"
export EDITOR='vim'
export VISUAL='vim'
...
__conda_setup="$('/Users/lmk/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/lmk/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/lmk/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/lmk/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# Qt related
export QT_PLUGIN_PATH=/Users/lmk/Qt/5.15.0/clang_64/plugins/
export QT_QPA_PLATFORM_PLUGIN_PATH=/Users/lmk/Qt/5.15.0/clang_64/plugins/platforms/
...
# poetry
export PATH="/Users/lmk/.local/bin:$PATH"
